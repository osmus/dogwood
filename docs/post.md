...
* defined in: [post](post-properties-date.md "dogwood/post.schema.json#/properties/date")
...
* defined in: [post](post-properties-caption.md "dogwood/post.schema.json#/properties/caption")
